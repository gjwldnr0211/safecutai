...
const AnalysisStep: React.FC<Props> = ({ onComplete, lang }) => {
  ...
  return (
    <div className="relative h-full w-full bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 top-0 bottom-0 w-full h-full z-0 transform scale-[0.96] rounded-[2rem] overflow-hidden origin-center shadow-2xl border border-white/10 bg-gray-900">
        <video 
          ref={videoRef}
          autoPlay 
          playsInline 
